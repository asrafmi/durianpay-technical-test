  ...
  <div class="grid h-screen grid-cols-[240px_1fr] bg-[#F6F6F8] font-sans text-[#14151C]">
    <aside class="flex flex-col bg-[#14151C] p-4 pt-6">
      ...
      <nav class="flex flex-col gap-0.5">
        <div
          class="flex cursor-not-allowed items-center gap-2.5 rounded-lg px-3 py-2.5 text-sm font-medium text-[#6B6B76]"
        >
          <span>Overview</span>
          <span class="ml-auto rounded-full bg-[#26272F] px-1.5 py-0.5 text-[10px] text-[#9A9AA6]">Soon</span>
        </div>
        <div
          class="flex items-center gap-2.5 rounded-lg border-l-[3px] border-[#E31C4D] bg-white/8 px-3 py-2.5 text-sm font-semibold text-white"
        >
          <span>Payments</span>
        </div>
        <div
    ...
    <div class="flex flex-col overflow-hidden">
      <header class="flex items-center justify-between border-b border-[#E5E5EA] bg-white px-10 py-5">
        <div>
					...
					<span
					class="rounded-full border border-[#E5E5EA] bg-[#F6F6F8] px-2 py-0.5 text-[11px] font-semibold text-[#3A3B45]"
					>
					{{ roleLabel }}
					</span>
        </div>
        ...
        <div class="flex items-center gap-2">
          <button
            ...
            class="flex h-9 w-9 cursor-pointer items-center justify-center rounded-lg border border-[#E5E5EA] bg-white text-[#6B6B76] transition-colors hover:border-[#B0B0BA]"
          >
          ...
          <div
            class="flex h-9 w-9 items-center justify-center rounded-full bg-[#14151C] text-xs font-bold text-white"
          >
            OP
          </div>
        </div>
