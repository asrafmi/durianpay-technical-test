...
const variantClasses = {
    ...
    danger: 'bg-danger text-white hover:bg-danger-dark disabled:opacity-70',
    success: 'bg-success text-white hover:bg-success-dark disabled:opacity-70',
}
...
<template>
    <button :type="type" :disabled="disabled || loading" :class="`${baseClasses} ${sizeClasses[size]} ${variantClasses[variant]} ${disabledClasses}`">
